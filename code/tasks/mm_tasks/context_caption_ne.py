...
from data.mm_data.context_caption_ne_dataset import ContextCaptionNeDataset
...
@dataclass
class ContextCaptionNeConfig(OFAConfig):
...
@register_task("context_caption_ne", dataclass=ContextCaptionNeConfig)
class ContextCaptionNeTask(OFATask):
    def __init__(self, cfg: ContextCaptionNeConfig, src_dict, tgt_dict):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = ContextCaptionNeDataset(
            split,
            dataset,
            self.bpe,
            self.src_dict,
