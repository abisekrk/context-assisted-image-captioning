...
from data.mm_data.context_caption_dataset import ContextCaptionDataset
...
@dataclass
class ContextCaptionConfig(OFAConfig):
...
@register_task("context_caption", dataclass=ContextCaptionConfig)
class ContextCaptionTask(OFATask):
    def __init__(self, cfg: ContextCaptionConfig, src_dict, tgt_dict):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = ContextCaptionDataset(
            split,
            dataset,
            self.bpe,
            self.src_dict,
            ...
            image_base_path='/research/goodnews_images/resized/',
            # image_base_path='/research/nytimes/downloaded_data/data/nytimes/images',
    ...
    def _inference(self, generator, sample, model):
        ...
        for i in range(len(gen_out)):
            if gen_out[i] and gen_out[i][0] and (gen_out[i][0]["tokens"] is not None):
