...
from data.mm_data.consistency_detection_dataset import ConsistencyDetectionDataset
...
@dataclass
class ConsistencyDetectionConfig(OFAConfig):
...
@register_task("consistency_detection", dataclass=ConsistencyDetectionConfig)
class ConsistencyDetectionTask(OFATask):
    def __init__(self, cfg: ConsistencyDetectionConfig, src_dict, tgt_dict):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = ConsistencyDetectionDataset(
            split,
            dataset,
            self.bpe,
            self.src_dict,
            ...
            image_base_path='/research/visualnews/origin',
