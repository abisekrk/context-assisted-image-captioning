...
from data.nlg_data.keyword_extraction_dataset import KeywordExtractionDataset
...
@dataclass
class KeywordExtractionConfig(OFAConfig):
...
@register_task("keyword_extraction", dataclass=KeywordExtractionConfig)
class KeywordExtractionTask(OFATask):
    def __init__(self, cfg: KeywordExtractionConfig, src_dict, tgt_dict):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        self.datasets[split] = KeywordExtractionDataset(
            split,
            dataset,
            self.bpe,
            self.src_dict,
