...
data_dir=../../dataset/pretraining_cap_only
...
log_dir=/research/OFA/run_scripts/pretrain_cap_only/logs
save_path=/research/OFA/run_scripts/pretrain_cap_only/checkpoints
