...
restore_file=/research/OFA/run_scripts/pretrain_cap_con_key/pretraining_visual_news_logs_checkpoints/checkpoint_2_24000.pt

data_dir=../../dataset/pretraining_cap_con_key
...
text_selected_cols=0,1,2
image_selected_cols=0,1,2
detection_selected_cols=0,1,2

log_dir=./pretraining_visual_news_logs_after_ep_1
save_path=./pretraining_visual_news_logs_checkpoints_after_ep_1
