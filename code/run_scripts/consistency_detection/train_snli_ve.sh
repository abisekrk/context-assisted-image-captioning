...
log_dir=./visual_test_logs
save_dir=./visual_test_checkpoints
mkdir -p $log_dir $save_dir

bpe_dir=../../utils/BPE
user_dir=../../ofa_module

data_dir=/research/visualnews/preprocessed/consistency_data
data=${data_dir}/train.tsv,${data_dir}/val.tsv
restore_file=../../checkpoints/ofa_large.pt
selected_cols=0,1,2,3,5
...
#     echo "lr "${lr}
    ...
    log_file=${log_dir}/"sample_"${max_epoch}"_"${lr}".log"
