...
data_dir=../../dataset/pretraining_cap_key
...
log_dir=/research/OFA/run_scripts/pretrain_cap_key/logs
save_path=/research/OFA/run_scripts/pretrain_cap_key/checkpoints
