...
log_dir=/research/OFA/run_scripts/context_caption/nytimes/ofa_large/stage1_logs
save_dir=/research/OFA/run_scripts/context_caption/nytimes/ofa_large/stage1_checkpoints
mkdir -p $log_dir $save_dir

bpe_dir=../../utils/BPE
user_dir=../../ofa_module

data_dir=/research/nytimes_processed_data/cleaned_and_position_filtered
data=${data_dir}/train.tsv,${data_dir}/val.tsv
restore_file=/research/OFA/checkpoints/ofa_large.pt
selected_cols=0,1,2,4
...
eval_cider_cached=/research/nytimes_processed_data/cleaned_and_position_filtered/cider_cached_tokens/valid-words.p
